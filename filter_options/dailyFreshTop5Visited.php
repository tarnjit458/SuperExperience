...
$query1 = "SELECT product_name, total_visits FROM products WHERE company_name='Daily Fresh' ORDER BY total_visits DESC LIMIT 5";
$result1 = mysqli_query($connection, $query1);
?>
<div class="col-lg-10 offset-lg-1 align-left kv-notify-inview section-text">
    <h2 class="section-title section-title--md" tabindex="0" data-type="text" style="text-align:center">Daily Fresh Top 5 Most Visited Products </h2>
