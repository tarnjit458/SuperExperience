      ...
      function (e, t, i) {
        ...
        var o = (function () {
          function r(e, t, i) {
            ...
            (this.resizeWaitTimeout = o ? 0 : 300),
              "undefined" != typeof window &&
                ((window._zoomUpdateEvents = window._zoomUpdateEvents || []),
          ...
          return (
            (function (e, t, i) {
              ...
              { key: "registerWindowEvent", value: function () {} },
              {
                key: "unregisterWindowEvent",
                value: function () {
                  if (
                    "undefined" != typeof window &&
                    window._zoomUpdateEvents
                  ) {
                    var e = window._zoomUpdateEvents.indexOf(
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  (o || o.length) &&
                    (this.checkMobileMode(n),
                    this.setHeaderHeight(e, t),
                    window.addEventListener("resize", function () {
                      i.__resizeTimeout &&
                        window.clearTimeout(i.__resizeTimeout),
                        (i.__resizeTimeout = window.setTimeout(function () {
                ...
                value: function (e, t) {
                  if (!e.model.cover && this.isRuntimeSite && t.parentElement) {
                    ...
                    if (i) {
                      ...
                      (o = n === i ? a : Math.max(r, a)),
                        (i.style.minHeight = "".concat(o, "px"));
                    }
                  }
                },
              },
              ...
              },
              {
                ...
                value: function (e, t) {
                  var i = e.querySelector("nav") || e,
                    n = e.querySelector(
                      '[data-dynamic-navigation-element="logo"]'
                    ),
                    o = e.querySelector(
                      '[data-dynamic-navigation-element="calltoactionbutton"]'
                    ),
                    r = o ? o.offsetWidth : 0,
                    a = n ? n.offsetWidth : 0,
                    u = i.offsetWidth - r;
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  var i = this.determineContainerWidth(
                      e,
                      this.currentElementWidth
                    ),
                    n = i.containerSize,
                    o = i.headerToWide,
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  if (((i = i || e), window.innerWidth < 991))
                    i.classList.contains("mobile") || i.classList.add("mobile");
                  else {
              ...
              { key: "updateProperty", value: function () {} },
            ]),
            r
          );
        })();
        (window.__features = window.__features || {}),
          (window.__features.navigation = o);
      },
      {},
    ],
  },
